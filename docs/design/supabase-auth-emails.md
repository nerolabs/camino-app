# Supabase auth email templates (Camino brand)
...
**Subject:** `Your Camino sign-in link`
...
<div style="max-width:560px;margin:0 auto;padding:32px 24px;font-family:Georgia,'Times New Roman',serif;color:#15243B;">
  <div style="font-size:22px;font-weight:600;margin-bottom:24px;">Camino <span style="color:#8A9BB0;font-size:14px;font-style:italic;">— your road to Spain</span></div>
  ...
  <div style="margin:24px 0;"><a href="{{ .ConfirmationURL }}" style="display:inline-block;background:#2B5AA3;color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:600;padding:12px 22px;border-radius:8px;">Sign in to Camino</a></div>
  ...
  <div style="font-family:Helvetica,Arial,sans-serif;font-size:12px;line-height:18px;color:#8A9BB0;">
    You’re getting this because this address was used to sign in to Camino.
...
**Subject:** `Confirm your email — your Camino account is almost ready`
...
<div style="max-width:560px;margin:0 auto;padding:32px 24px;font-family:Georgia,'Times New Roman',serif;color:#15243B;">
  ...
  <p style="font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:24px;margin:0 0 16px;">One tap to confirm this address and your Camino account is ready:</p>
  ...
  <p style="font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#4A5A70;margin:0 0 8px;">Reading this on a different device? Enter this code in the app instead:</p>
  <div style="margin:0 0 24px;"><span style="display:inline-block;font-family:'Courier New',Courier,monospace;font-size:28px;letter-spacing:8px;font-weight:700;color:#15243B;background:#FFFFFF;border:1px solid #E8E4DC;border-radius:10px;padding:14px 18px;">{{ .Token }}</span></div>
  <p style="font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;color:#8A9BB0;margin:0 0 16px;">The link and code expire in an hour. Didn’t create a Camino account? You can safely ignore this email.</p>
  <hr style="border:none;border-top:1px solid #E8E4DC;margin:32px 0 16px;">
  <div style="font-family:Helvetica,Arial,sans-serif;font-size:12px;line-height:18px;color:#8A9BB0;">
    You’re getting this because this address was used to create a Camino account.
    <br>Guidance only — not legal or tax advice.
  </div>
</div>
</body></html>
