...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'A move-cost estimate — what the whole move costs', note: 'The roadmap tells you what to do and when; this adds what it costs. A researched pass priced every step in the catalog and sorted them by how honestly we can state each one — a fixed government fee, a percentage of your home price, a personal cost only you can set, or free. It\'s built behind the scenes as a new "Costs" tab, and switched off while we check each figure against its official source: the fixed government fees are verified now; the percentages and market prices stay marked as estimates until they\'re checked too. The total is always a range, and personal costs (a scouting trip, a lawyer) stay yours to set — we won\'t guess them.' },
    ],
  },
  {
    h: 'Next',
