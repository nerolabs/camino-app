...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'The Android app — in closed testing', note: 'The remaining leg is well underway. The hardware install-proof (the sibling of the iPhone\'s App Attest) is built and verified on a real phone, so the interview works from the first build. The store listing is complete — screenshots and all — and the verified build is now submitted to Google\'s closed-testing track for review. Google requires a dozen real testers on that track for two continuous weeks before an app can go public, so recruitment is open: Android visitors to this site see an invitation to join. Then the Play Store. Android ships phone-only, like the iPhone.' },
