...
export default function TermsPage() {
  return (
    <LegalPage
      title="Terms of use"
      metaTitle="Terms of use | Camino"
      description="The deal, in plain language: Camino is guidance, not legal or tax advice — sourced carefully, verified by you."
      canonical="https://getcamino.app/terms"
      updated="4 July 2026"
      intro="The short version: Camino organizes your move and points at official sources, but it isn't a law firm, a gestoría, or a tax adviser — and rules change. Use it as your map; confirm the specifics for your case before acting on them."
      sections={[
        { h: 'What Camino is (and isn\'t)', body: [
          'Camino turns your answers into a sequenced plan for moving to Spain, with official steps citing government sources. It is general guidance — not legal, tax, or immigration advice, and using it doesn\'t create any professional-client relationship.',
        ...
        { h: 'Liability', body: [
          'Camino is provided free and "as is". To the maximum extent permitted by law, Proxim.us is not liable for indirect or consequential losses (including missed deadlines, visa outcomes, or tax consequences) arising from use of the service. Nothing in these terms excludes liability that cannot lawfully be excluded.',
        ]},
        { h: 'Intellectual property', body: [
          'The Camino product, brand, catalog structure and content are ours; your answers and your roadmap are yours. Official sources belong to their governments — that\'s rather the point.',
        ]},
        { h: 'Governing law', body: [
          'These terms are governed by the laws of the State of Washington, United States, where the operator is based. If you use Camino as a consumer in the EU, mandatory consumer protections of your country still apply to you.',
        ]},
        { h: 'Changes', body: [
