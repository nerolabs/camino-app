...
// The German web route tree (L2 — docs/LOCALIZATION.md §6): every fully-translated public
// page also lives under /de/… as a RE-EXPORT of the same screen; the root layout's
// route-locale forcing makes them render (and statically export) in German. English keeps
