...
export const GUIDE_PROSE: Record<string, string> = {
  ...
  'eu-family-member-card':
    'If your household mixes passports — one of you EU or Spanish, the other not — the non-EU family member doesn\'t ride a visa: once in Spain they apply for the EU family-member residence card (form EX-19), in person, within 3 months of entry. The receipt you\'re handed on filing already proves legal residence while the card is processed. Bring apostilled, translated proof of the family relationship (marriage or birth certificates) and evidence of the EU or Spanish family member\'s own status.',
  ...
  'self-employment-visa-authorization':
    'Spain will let you move to work for yourself, but it wants to see a real business first: a viable plan, money to fund it, and whatever licences the activity needs. The authorization is assessed before your consulate visa, so the plan and evidence come together at the very start. A gestor who has shepherded these files knows what "viable" reads like to the reviewing office — money well spent here.',
  'university-admission':
    'Everything in the student route hangs off one document: the admission letter. Programs have their own calendars — often closing many months before the term — so treat the application season, not the visa, as your real deadline. Once admitted, the visa paperwork is comparatively mechanical.',
  ...
  'citizenship-married-to-spanish':
    'The fastest road to a Spanish passport isn\'t ten years — it\'s marriage to a Spaniard plus 1 year of legal residence. The conditions are precise: legally married (not separated), the marriage registered in Spain if it happened abroad, and the residence year legal, continuous, and immediately before applying. For mixed households this changes the whole long-term plan — worth knowing from day one.',
  'ehic-card':
    'For a short stay, the EHIC is the entire healthcare answer: it entitles you to medically necessary public care in Spain on the same terms as locals. Order it from your home country\'s health service before you travel — it\'s free, and the card (not a screenshot of it) is what clinics ask for. It doesn\'t replace travel insurance for cancellations or repatriation.',
  'schengen-90-180':
