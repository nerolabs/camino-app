...
export const ES_GUIDE_PROSE: Record<string, string> = {
  ...
  'eu-family-member-card':
    'Si en tu hogar se mezclan pasaportes — uno de la UE o español, otro no — el familiar no comunitario no va por la vía del visado: ya en España solicita la tarjeta de familiar de ciudadano de la Unión (modelo EX-19), en persona, dentro de los 3 meses desde la entrada. El resguardo que te dan al presentarla ya acredita la residencia legal mientras tramitan la tarjeta. Lleva pruebas apostilladas y traducidas del vínculo familiar (certificados de matrimonio o nacimiento) y la acreditación del familiar comunitario o español.',
  'residencia':
