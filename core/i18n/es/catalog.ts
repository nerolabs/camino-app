...
export const ES_CATALOG_TITLES: Record<string, string> = {
  ...
  'consulate-appointment': 'Reserva cita en el consulado para presentar tu solicitud de visado — los plazos varían mucho según el consulado, así que reserva cuanto antes; las citas se gestionan por el sistema de cita previa del consulado',
  ...
  'work-visa-employer-sponsored': 'Visado de trabajo (cuenta ajena): tu empleador español presenta por ti la autorización de residencia y trabajo (modelo EX-03) antes de mudarte — esta vía no se puede tramitar por cuenta propia, así que asegura la oferta primero y coordina los tiempos con la presentación del empleador',
  'self-employment-visa-authorization': 'Visado por cuenta propia: solicita la autorización inicial de residencia y trabajo con un plan de negocio viable, prueba de fondos suficientes y las licencias que exija tu actividad — la autorización llega antes que el visado del consulado',
  'university-admission': 'Asegura primero tu plaza de estudios — el visado de estudiante cuelga de la carta de admisión de una institución española, así que las solicitudes, sus plazos y tu aceptación van antes que cualquier papeleo de visado',
  'homologacion-titulos': 'Si vas a estudiar con — o ejercer una profesión regulada con — un título extranjero, inicia pronto su reconocimiento oficial (homologación o equivalencia por el portal Valida-TE del Ministerio); estos expedientes avanzan despacio',
  'job-seeker-route-reality': 'Atención: España no tiene un visado general de búsqueda de empleo — quien no es de la UE y planea buscar trabajo en el país normalmente necesita una autorización promovida por un empleador ANTES de mudarse. Consigue el trabajo primero, o repasa rutas realistas con un asesor de extranjería',
  'dgt-eu-licence-check': 'Tu permiso de conducir de la UE sigue siendo válido en España — pero si tiene vigencia indefinida o más de 15 años por delante, debes renovarlo en la DGT cuando pasen 2 años de residencia; canjearlo antes es voluntario',
  'citizenship-married-to-spanish': 'Vía rápida de nacionalidad para el cónyuge de ciudadano español: tras solo 1 año de residencia legal (casados y no separados; los matrimonios celebrados fuera deben inscribirse en España), el cónyuge no español puede solicitar la nacionalidad',
  'ehic-card': 'Pide tu Tarjeta Sanitaria Europea (TSE) antes de viajar — en una estancia corta cubre la sanidad pública médicamente necesaria en España como a un residente, gratis desde tu servicio de salud',
  'schengen-90-180': 'Las estancias cortas van con el reloj Schengen: como máximo 90 días en cualquier ventana de 180 — y algunos pasaportes necesitan visado Schengen incluso para turismo. Comprueba la regla de tu pasaporte antes de reservar',
