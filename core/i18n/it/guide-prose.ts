...
export const IT_GUIDE_PROSE: Record<string, string> = {
  ...
  'consulate-appointment':
    'I visti di lungo periodo si presentano dal tuo paese, al consolato spagnolo competente per il tuo domicilio — tramite il suo sistema di cita previa. Il collo di bottiglia è di solito l’appuntamento, non le carte: fissa prima la data e prepara i documenti puntando a quella. I tempi di attesa variano molto da consolato a consolato — poche settimane in alcuni, diversi mesi in altri — e la pagina del tuo consolato fa fede sui tempi attuali.',
  ...
  'eu-family-member-card':
    'Se nel tuo nucleo i passaporti si mescolano — uno di voi UE o spagnolo, l\'altro no — il familiare non UE non passa da un visto: una volta in Spagna richiede di persona, entro 3 mesi dall\'ingresso, la carta di soggiorno di familiare (modulo EX-19). La ricevuta consegnata alla presentazione prova già la residenza legale mentre la carta viene lavorata. Porta prove apostillate e tradotte del legame familiare (certificati di matrimonio o nascita) e la documentazione dello status del familiare UE o spagnolo.',
  'residencia':
